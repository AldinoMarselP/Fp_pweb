...
<body>
    ...
    <div class="container mt-3 mb-3 shadow p-3 mb-3 bg-body rounded">
        ...
        <div class="row align-items-start">
            <div class="col">
                <h1 class="ms-5 pt-4 text-center">Managemen Blog</h1>
                <div class="row ms-4 mt-5 justify-content-center">
                    <div class="mb-3 text-center">
                        <a href="blogtambah.php" class="btn btn-success">+ Tambah</a>
                    </div>
                    <div class="col-11">
                            ...
                            <tbody>
                                ...
                                while($d = mysqli_fetch_array($data)){
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="file_foto_blog/<?php echo $d['gambar']; ?>" style="height: 70px"></td>
                                        <td class="truncate"><?php echo $d['judul']; ?></td>
                                        <td class="truncate"><?php echo $d['konten']; ?></td>
                                        <td>
                                            <a href="blogupdate.php?id=<?php echo $d['id_blog']; ?>" class="btn btn-primary btn-sm">Edit</a>
                                            <a href="bloghapus_aksi.php?id=<?php echo $d['id_blog']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php 
                                }
