    ...
    <section>
        ...
        <div id="offcanvas">
            ...
            <div class="row align-items-start">
                <div class="col">
                    <h1 class="ms-5 pt-4 text-center mb-5">Selamat Datang Admin IndoBus</h1>
                    <hr>
                    <h1 class="ms-5 pt-4 text-center">Data Mitra Bus</h1>
                    <div class="row ms-4 mt-5 justify-content-center">
                        <div class="mb-3 text-center">
                            <a href="tambahmitra.php"><button type="submit" class="btn btn-success">+ Tambah</button></a>
                        </div>
                        <div class="col-11">
                            ...
                            <tr>
                                ...
                                <td><img src="file_foto/<?php echo $d['logomitra']; ?>" style="height: 70px"></td>
                                <td><?php echo $d['namaper']; ?></td>
				                <td><?php echo $d['namapem']; ?></td>
				                <td class="truncate"><?php echo $d['alamat']; ?></td>
				                <td><?php echo $d['email']; ?></td>
                                <td>
                                    <a href="editmitra.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
                                    <a href="hapusmitra.php?id=<?php echo $d['id']; ?>"><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
                                </td>
                            </tr>
                            <?php 
                        }
