...
<header>
	...
	include 'koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($koneksi,"select * from mitra where id='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
        <form enctype="multipart/form-data" method="post" action="updatemitra.php">
        ...
        <div id="offcanvas">
            ...
            <div class="row align-items-start">
                    <div class="col">
                        <h1 class="ms-5 pt-4 text-center">Ubah Data Mitra Bus</h1>
                    <div class="row ms-4 mt-5 justify-content-center">
                        <div class="col-6">
                            <div class="container mt-4">
                                <div class="row align-items-start">
                                    <div class="col">
                                        <label for="formFile" class="form-label">Logo Mitra</label>
                                        <input class="form-control" type="file" name="logomitra" id="formFile" accept="image/*">
                                    </div>
                                </div>
                            </div>
                            <div class="row align-items-start">
                                <div class="col text-center">
                                    <?php
                                    if (!empty($d['logomitra'])) {
                                        echo '<img src="file_foto/' . $d['logomitra'] . '" class="img-thumbnail" alt="Logo">';
                                    } else {
                                        echo '<img src="placeholder.png" class="img-thumbnail" alt="Logo">';
                                    }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="container mt-4">
                                <div class="row align-items-start">
                                    <div class="col">
                                        <label for="exampleFormControlInput1" class="form-label ms-2">Nama Perusahaan</label>
                                        <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
						                <input type="text" class="form-control" name="namaper" value="<?php echo $d['namaper']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="container mt-4">
                                    <div class="row align-items-start">
                                        <div class="col">
                                            <label for="inputAsal" class="form-label ms-2">Nama Pemilik</label>
                            ...
                            <div class="mb-3">
                                <div class="container mt-4">
                                    <div class="row align-items-start">
                                        <div class="col">
                                            <label for="inputTujuan" class="form-label ms-2">Alamat</label>
                                ...
                                <div class="container mt-4">
                                    <div class="row align-items-start">
                                        <div class="col">
                                            <label for="inputTarif" class="form-label ms-2">Email</label>
                                ...
                                <div class="mb-3 text-center p-3">
                                    <a href="datamitra.php"><button type="submit" class="btn btn-outline-secondary btn-lg">Batal</button></a>
