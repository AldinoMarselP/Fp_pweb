...
<head>
    ...
    <title>Data Pengaduan User</title>
    ...
    <section>
        <div class="container mt-3 mb-3 shadow p-3 mb-3 bg-body rounded">
            ...
            <div class="row align-items-start">
                <div class="col">
                    <h1 class="ms-5 pt-4 text-center">Data Pengaduan User</h1>
                        ...
                        <div class="col-11">
                            <table class="table text-center mb-5 table-striped">
                                ...
                                <tbody>
                                    ...
                                    include 'koneksi.php';
                                    $no = 1;
                                    $data = mysqli_query($koneksi,"select * from pengaduan_user");
                                    while($d = mysqli_fetch_array($data)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="det_peng_user.php?id=<?php echo $d['id_pengaduan_user']; ?>" class="btn btn-primary btn-sm">Detail</a>
                                                <a href="hapuspengaduan.php?id=<?php echo $d['id_pengaduan_user']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                                            </td>
                                        </tr>
                                        <?php 
                                    }
