...
<header>
    ...
    <section>
        <form enctype="multipart/form-data" method="post" action="tambahmitra_aksi.php">
        <div class="container mt-3 mb-3 shadow p-3 mb-3 bg-body rounded">
            ...
            <div class="row align-items-start">
                <div class="col">
		            <h1 class="ms-5 pt-4 text-center">Tambah Mitra Bus</h1>
                <div class="row ms-4 mt-5 justify-content-center">
                        <div class="col-6">
                            <div class="container mt-4">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <input class="form-control" type="file" name="logomitra" id="formFile">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container mt-4">
                                <div class="row align-items-start">
                                    <div class="col">
                                        <label for="exampleFormControlInput1" class="form-label ms-2">Nama Perusahaan Mitra</label>
                                        <input type="text" class="form-control" name="namaper" placeholder="Nama Perusahaan Mitra">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="container mt-4">
                                    <div class="row align-items-start">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="namapem" placeholder="Nama Pemilik">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="container mt-4">
                                        <div class="row align-items-start">
                                            <div class="col">
                                                <label for="inputTujuan" class="form-label ms-2">Email</label>
                                ...
                                <div class="mb-3 text-center p-3">
                                    <a href="datamitra.php"><button type="button" class="btn btn-outline-secondary btn-lg" id="batal" class="btn btn-outline-secondary btn-lg">Batal</button></a>
