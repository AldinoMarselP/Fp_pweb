...
<header>
    ...
    <section>
        <form method="post" action="tambahtransaksi_aksi.php">
        <div class="container mt-3 mb-3 shadow p-3 mb-3 bg-body rounded">
            ...
            <div class="row align-items-start">
                <div class="col">
		            <h1 class="ms-5 pt-4 text-center">Tambah Transaksi</h1>
                        ...
                        <div class="col-6">
                            <div class="container mt-4">
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" name="namapem" placeholder="Nama Pembayar">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="container mt-4">
                                    <div class="row align-items-start">
                                        <div class="col">
                                            ...
                                            <input type="date" class="form-control" name="tanggal" placeholder="Tanggal Pembayaran">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                <div class="container mt-4">
                                    <div class="row align-items-start">
                                        <div class="col">
                                            <label for="inputAsal" class="form-label ms-2">Nama Bus</label>
                                            <input type="text" class="form-control" name="namabus" placeholder="Nama Bus">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="container mt-4">
                                        <div class="row align-items-start">
                                            <div class="col">
                                                <label for="inputTujuan" class="form-label ms-2">Rute</label>
                                                <input type="text" class="form-control" name="rute" placeholder="Asal - Tujuan">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container mt-4">
                                        <div class="row align-items-start">
                                            <div class="col">
                                                <label for="inputTarif" class="form-label ms-2">Harga</label>
                                ...
                                <div class="mb-3 text-center p-3">
                                    <a href="index.php"><button type="button" class="btn btn-outline-secondary btn-lg" id="batal" class="btn btn-outline-secondary btn-lg">Batal</button></a>
